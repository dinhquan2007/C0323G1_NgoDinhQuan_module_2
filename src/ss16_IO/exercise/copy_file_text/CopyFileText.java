package ss16_IO.exercise.copy_file_text;
...
public class CopyFileText {
    public static void main(String[] args) {
        ...
        Student student3=new Student("A13","Quanh","1996",false,"C0323G1",8);
        Student student4=new Student("A14","Quat","1996",true,"C0323G1",5);
        Student student5=new Student("A15","Quyt","1989",true,"C0323G1",6);
        Student student6=new Student("A16","Que","1998",true,"C0323G1",7);
        ...
        writeStudentListToFile(studentList,"ss16_IO/exercise/read_file_csv/test.csv");
        List<Student> studentsListFromFile=readStudentListFromFile("ss16_IO/exercise/read_file_csv/test.csv");
        for (Student student:studentList) {
            System.out.println(student);
        }
        System.out.println(readStudentListFromFile( "ss16_IO/exercise/read_file_csv/test.csv"));
    }
